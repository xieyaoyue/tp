...
public class ItemTest {
    ...
    public void testStringConversion() {
        String expectedString = date.toString() + " [Others] rice SGD 2.0000";
        assertEquals(expectedString, rice.toString());
    }

    @Test
    public void editAmount() {
        String expectedString = date.toString() + " [Others] rice SGD 5.0000";
        rice.editAmount(5);
        assertEquals(expectedString, rice.toString());
    }
    ...
    public void editDescription() {
        String expectedString = date.toString() + " [Others] chicken rice SGD 2.0000";
    ...
    public void editSymbol() {
        String expectedString = date.toString() + " [Others] rice USD 2.0000";
        rice.editSymbol("USD");
        assertEquals(expectedString, rice.toString());
    }
